...
public class Enemy5DamageDetection : MonoBehaviour {
    ...
    void Start () {
        ...
        //life = GameStats.Enemy5Life;

        //life = GameStats.allEnemyStartLife;

        //multiplier = GameStats.Enemy5LifeMultiplier;
	...
	void Update () {
        if (sendInfo && MenuButtons.UIStatsEnemyEnabled)
        {
            ...
            MenuButtons.UpdateUIStatsInfo(GameStats.Enemy5AvatarStatic, GameStats.Enemy5Name, "", "", "", "Life: " + life + "/" + maxLife, "", "Speed: " + gameObject.GetComponent<Enemy5Movement>().enemySpeed.ToString(), "", "Worth: " + worth + "$", "", "", "", "", "");
        }
        else
        {
            sendInfo = false;
    ...
    {
        float lastSpeed = gameObject.GetComponent<Enemy5Movement>().enemySpeed;
        if (gameObject.GetComponent<Enemy5Movement>().enemySpeed == GameStats.Enemy5Speed)
        {
            float newSpeed = gameObject.GetComponent<Enemy5Movement>().enemySpeed *= GameStats.Tower3AOEFreezeSpeedScale;
            Mathf.Round(newSpeed);
            gameObject.GetComponent<Enemy5Movement>().enemySpeed = newSpeed;
        }
        else
        {
        ...
        gameObject.GetComponent<Enemy5Movement>().enemySpeed = lastSpeed;
