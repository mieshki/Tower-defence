...
public class GameStats : MonoBehaviour {
    ...
    //public static float Tower2AOEScale = 5f;
    ...
    //public static float allEnemyLifeUpdated = Mathf.Round(allEnemyStartLife * Mathf.Pow(allEnemyLifeMultiplier, WaveSpawning.waveIndex - 1));



    // ENEMY1 normalne
    public static string Enemy1Name = "Normal";
    //public static float Enemy1Life = 10f;
    public static float Enemy1Speed = 5f;
    //public static float Enemy1LifeMultiplier = 1.5f;

    // ENEMY2 szybkie
    public static string Enemy2Name = "Fast";
    //public static float Enemy2Life = 15f;
    public static float Enemy2Speed = 6.5f;
    //public static float Enemy2LifeMultiplier = 7f;

    // ENEMY3 wolne
    public static string Enemy3Name = "Slow";
    //public static float Enemy3Life = 30f;
    public static float Enemy3Speed = 3.5f;
    //public static float Enemy3LifeMultiplier = 15f;

    // ENEMY4 latajace
    public static string Enemy4Name = "Air";
    //public static float Enemy4Life = 20f;
    ...
    //public static float Enemy5Life = 20f;
    public static float Enemy5Speed = 3.5f;
    //public static float Enemy5LifeMultiplier = 4f;

    // ENEMY6 bosssss
    public static string Enemy6Name = "BOSS";
    //public static float Enemy6Life = 100f;
    public static float Enemy6Speed = 3f;
    //public static float Enemy6LifeMultiplier = 50f;
