...
public class Enemy2DamageDetection : MonoBehaviour {
    ...
    void Start () {
        ...
        //multiplier = GameStats.Enemy2LifeMultiplier;
	...
	void Update () {
        if (sendInfo && MenuButtons.UIStatsEnemyEnabled)
        {
            ...
            MenuButtons.UpdateUIStatsInfo(GameStats.Enemy2AvatarStatic, GameStats.Enemy2Name, "", "", "", "Life: " + life + "/" + maxLife, "", "Speed: " + gameObject.GetComponent<Enemy2Movement>().enemySpeed.ToString(), "", "Worth: " + worth + "$", "", "", "", "", "");
        }
        else
        {
            sendInfo = false;
    ...
    {
        float lastSpeed = gameObject.GetComponent<Enemy2Movement>().enemySpeed;
        if (gameObject.GetComponent<Enemy2Movement>().enemySpeed == GameStats.Enemy2Speed)
        {
            float newSpeed = gameObject.GetComponent<Enemy2Movement>().enemySpeed *= GameStats.Tower3AOEFreezeSpeedScale;
            Mathf.Round(newSpeed);
            gameObject.GetComponent<Enemy2Movement>().enemySpeed = newSpeed;
        }
        else
        {
        ...
        gameObject.GetComponent<Enemy2Movement>().enemySpeed = lastSpeed;
